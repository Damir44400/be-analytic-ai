...
from src.dashboard.domain.interfaces.daos.branches import ICompanyBranchCreateDAO
from src.dashboard.domain.interfaces.daos.companies import ICompanyGetByUserIdDAO
from src.dashboard.domain.interfaces.daos.emopoyees import IEmployeeGetByUserIdDAO, IEmployeeCreateDAO
